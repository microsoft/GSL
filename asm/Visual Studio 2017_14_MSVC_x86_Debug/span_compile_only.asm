...
CONST	SEGMENT
$SG51568 DB	'GSL: Postcondition failure at c:\projects\gsl\include\gs'
	DB	'l\string_span: 114', 00H
	ORG $+5
$SG51569 DB	'GSL: Postcondition failure at c:\projects\gsl\include\gs'
	DB	'l\string_span: 118', 00H
	ORG $+5
$SG51570 DB	'GSL: Postcondition failure at c:\projects\gsl\include\gs'
	DB	'l\string_span: 122', 00H
	ORG $+1
$SG39436 DB	'iVtrau lDC', 00H
	ORG $+1
$SG39743 DB	'iVtrau lDC', 00H
	ORG $+5
$SG48208 DB	'GSL: Precondition failure at c:\projects\gsl\include\gsl'
	DB	'\gsl_algorithm: 50', 00H
	ORG $+5
$SG48708 DB	'GSL: Precondition failure at c:\projects\gsl\include\gsl'
	DB	'\gsl_algorithm: 50', 00H
CONST	ENDS
