...
$SG48099 DB	'c:\projects\gsl\tests\span_compile_only.cpp', 00H
$SG48483 DB	'(s.size() == 0 && s.data() == nullptr)', 00H
	ORG $+1
$SG48484 DB	'c:\projects\gsl\tests\span_compile_only.cpp', 00H
$SG48485 DB	'CHECK', 00H
	ORG $+2
$SG48489 DB	'(cs.size() == 0 && cs.data() == nullptr)', 00H
	ORG $+3
$SG48490 DB	'c:\projects\gsl\tests\span_compile_only.cpp', 00H
$SG48491 DB	'CHECK', 00H
CONST	ENDS
